...
Project to practice JavaScript and DOM manipulation.<br/>
Display a random movie every time you click "Find Something"<br/>

Yet to implement:<br/>

- Use themoviedb.org API to display a random movie.<br/>
